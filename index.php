		...
		<div class="container" style="">
			<div class="row-fluid resultsblock" id="mainbar">
				...
				<div class="col-lg-3" style="padding-left: 0;">
					<div class="hide-1200" id="sidebar" style="position: absolute; width: auto; right: 15px;">
...
function createSidebar(){
	...
	var sidebar = $("#sidebar");
	var resultswidth = $(".filters-desktop").width()+$(".sidenav").width();
		...
		console.log(q.length);
	   	...
	   	if (sidebarstate == "closed") {
			$(function() {
				...
				$("#full-dashboard").animate({'width':resultswidth+"px"}, {duration: 600, queue: false, complete: function(){
			...
			$(function() {
	    	    ...
	    	    $("#mySidenav").animate({width: sidewidth+"px"}, {duration: 1600, queue: false, complete: function(){
			    	$(".rotate").toggleClass("down");
					sidebarstate = "closed"; 
				}});
			});
