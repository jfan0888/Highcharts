...
<head>
	...
	<style>
		...
		*:after {
		...
		.datefilter { background:#fff; cursor:pointer; width:100%; margin-top:3px;
		.sortlist { margin-left:50px; }margin-left:15px; color: #222222; 'Univers LT 45', Arial, sans-serif; font-size:13px; }
